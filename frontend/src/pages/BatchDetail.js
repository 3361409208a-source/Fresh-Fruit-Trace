        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div style={card}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
              ...
              <InfoItem icon={Clock} label="有效期至" value={expTime} highlight={isExpired ? 'red' : batch.expire_at ? 'green' : null} />
...
function PrintLabel({ batch, traceUrl, isExpired }) {
...
function LabelRow({ label, value, highlight }) {
  return (
...
function InfoItem({ icon: Icon, label, value, highlight }) {
  const colors = { red: '#dc2626', green: '#16a34a' };
  return (
